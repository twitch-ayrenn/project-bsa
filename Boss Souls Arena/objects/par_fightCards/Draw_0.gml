...
if (drawCompletedText == true)
{
	...
	draw_text_transformed_color(x,y+17,"Defeated",0.12*size,0.12*size,0,global.goldColor,global.goldColor,c_yellow,c_yellow,1);
	draw_text_transformed_color(x,y+7,"Enemy",0.12*size,0.12*size,0,global.goldColor,global.goldColor,c_yellow,c_yellow,1);	
