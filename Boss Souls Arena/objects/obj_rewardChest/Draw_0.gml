...
if (phase == 3)
{
	...
	if (gameMaster.chosenBoss == Boss.FlameWisp){draw_sprite_ext(spr_loot_flamie, 0,x-9, y-30+yUpDown+yUpFade, itemScale, itemScale, image_angle, image_blend, alphaUpFade);}
	if (gameMaster.chosenBoss == Boss.TheCorrupter){draw_sprite_ext(spr_loot_EdgeOfCorruption, 0,x-9, y-30+yUpDown+yUpFade, itemScale, itemScale, image_angle, image_blend, alphaUpFade);}
	if (gameMaster.chosenBoss == Boss.FlameGate){draw_sprite_ext(spr_loot_demonHorn, 0,x-9, y-30+yUpDown+yUpFade, itemScale, itemScale, image_angle, image_blend, alphaUpFade);}
	if (gameMaster.chosenBoss == Boss.WispSisterJulia){draw_sprite_ext(spr_loot_futuristic_soldier, 0,x-9, y-30+yUpDown+yUpFade, itemScale, itemScale, image_angle, image_blend, alphaUpFade);}
	if (gameMaster.chosenBoss == Boss.AngelSlayerRekZul){draw_sprite_ext(spr_loot_netherPortal, 0,x-9, y-30+yUpDown+yUpFade, itemScale, itemScale, image_angle, image_blend, alphaUpFade);}
	if (gameMaster.chosenBoss == Boss.DeathKnight){draw_sprite_ext(spr_loot_deathScythe, 0,x-9, y-30+yUpDown+yUpFade, itemScale, itemScale, image_angle, image_blend, alphaUpFade);}
	...
	if (gameMaster.chosenBoss == Boss.AngelKnightOscar){draw_sprite_ext(spr_loot_hourglass, 0,x-9, y-30+yUpDown+yUpFade, itemScale, itemScale, image_angle, image_blend, alphaUpFade);}
	...
	if (gameMaster.chosenBoss == Boss.BossRushReward){draw_sprite_ext(spr_loot_dungeonHeart, 0,x-9, y-30+yUpDown+yUpFade, itemScale, itemScale, image_angle, image_blend, alphaUpFade);}
