...
{
	var damageDealt = global.damage*0.5;
	...
	with (enemy)
	{	
		hp -= global.damage*0.5;
	}
	var amountHealed = global.damage*0.5*0.4*global.bookOfHealingHealBoost;
	...
	with (obj_player)
	{
		hp += global.damage*0.5*0.4*global.bookOfHealingHealBoost;
	}
	instance_destroy();
}