...
if  (doAttacks == true)
{
	...
	if (phase == 1)
	{
		if(chooseAnAttack == true)
		{
			...
			globalvar chooseAttack3; 
			chooseAttack3 = choose(
			...
			if (chooseAttack3 == GeneralAttacks.ScytheAttacks)
			{
				sprite_index = spr_deathKinghts_scythe;
				generalSpeed = 3;
				global.spinTimes = 6;
			}
			if (chooseAttack3 == GeneralAttacks.TpAttack)
			{
				sprite_index = spr_deathKinghts_teleport;
			}
			if (chooseAttack3 == GeneralAttacks.Cone_Attack)
			{
				sprite_index = spr_deathKinghts_cone;
				generalSpeed = 1.4;
			}
			if (chooseAttack3 == GeneralAttacks.Cirkle_Attack)
			{
...
if (phase == 1 && hp <= 0)
{
	...
	if (instance_exists(obj_deathKnightScythe_3)){with(obj_deathKnightScythe_3){instance_destroy();}}
