...
draw_text_transformed_color(455,750,"The Soul Wisp",0.4,0.4,0,c_white,c_white,c_white,c_white,1);
draw_healthbar(800,800+20,800+350,800-10,(hp / maxHp) * 100,c_black,c_red,c_maroon,0,true,false);
draw_healthbar(800,800+20,800-350,800-10,(hp / maxHp) * 100,c_black,c_red,c_maroon,0,true,false);
draw_sprite_ext(spr_boss_theSoulWisp,0,1165,815,2,2,0,phaseColor,1);
...
if (phase == 1)
{
	...
	draw_rectangle_color(800-350+35,825,800-350+30+35,825+30,c_purple,c_purple,c_purple,c_purple,false);
	draw_rectangle_color(800-350+70,825,800-350+30+70,825+30,c_yellow,c_yellow,c_yellow,c_yellow,false);
