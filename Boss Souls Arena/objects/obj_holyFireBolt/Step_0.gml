...
if (place_meeting(x,y,enemy))
{
	...
	var damageDealt = global.damage*3*type;
	...
	enemy.hp -= global.damage*3*type;
	
	var amountHealed = global.damage*3*global.lifeSteal*type;
	...
	obj_allPlayer.hp += global.damage*3*global.lifeSteal*type;
	instance_destroy();
}
