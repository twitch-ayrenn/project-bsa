...
depth = obj_ads_deathKnights_1.depth;
x = obj_ads_deathKnights_1.x;
y = obj_ads_deathKnights_1.y;
...
if (state == DeathScytheState.Attack)
{
	...
	if (place_meeting(x,y,obj_player))
	{
		...
		with (obj_ads_deathKnights_1)
		{
			var healBossAmount = global.dkScytheDamage*0.4;
			var healBoss = instance_create_depth(obj_ads_deathKnights_1.x+irandom_range(-8,8),obj_ads_deathKnights_1.y+irandom_range(-5,5),obj_ads_deathKnights_1.depth-10,obj_textMaker);
