...
{
	var damageToTarget = instance_nearest(x,y,obj_ads_bloodBatNormal).damage;
	...
	with (target)
	{
		hp -= instance_nearest(x,y,obj_ads_bloodBatNormal).damage;
	}
	var healBossAmount = instance_nearest(x,y,obj_ads_bloodBatNormal).damage*0.4;
	...
	{
		hp += instance_nearest(x,y,obj_ads_bloodBatNormal).damage*0.4;
	}
	instance_destroy();
}