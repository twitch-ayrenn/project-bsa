...
{
	var damageDealt = global.damage*9*global.player.conjurationPower;
	...
	with (enemy)
	{	
		hp -= global.damage*9*global.player.conjurationPower;
	}
	
	with(obj_camera){shake_remain += 4}
	
	var amountHealed = global.damage*9*global.lifeSteal*global.player.conjurationPower;
	...
	with (obj_allPlayer)
	{
		hp += global.damage*9*global.lifeSteal*global.player.conjurationPower;
	}
	instance_destroy();
}
