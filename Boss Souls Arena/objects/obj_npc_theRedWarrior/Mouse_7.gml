...
if (gameMaster.theRedWarriorUnlocked == true && gameMaster.menu == Menues.PlayerSelect || 
gameMaster.theRedWarriorUnlocked == true && gameMaster.menu == Menues.Main)
{
	...
	with (gameMaster)
	{
		...
		global.itemSlots = int64(1 + ((theRedWarriorProgress-1)/4));
