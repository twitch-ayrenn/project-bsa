...
if (type = CrowdType.Demon)
{
	...
	bodyColor = choose(make_color_rgb(19,19,19));
...
if (type = CrowdType.DoodleWithPants)
{
	...
	bodyColor = choose(c_green,c_navy,c_teal,c_purple,c_maroon,global.darkYellow,global.paleViolet,global.skyBlue);
	image_blend = bodyColor;
...
if (type = CrowdType.CloakedDoodle)
{
	...
	bodyColor = choose(c_lime,c_aqua,c_fuchsia,c_purple,c_red,c_yellow,global.skyBlue);
	image_blend = bodyColor;
	alpha = 0.75;
	image_alpha = alpha;
}
